                ...
                <div class='ml-64 bg-slate-200 w-2/5 h-72 rounded-lg border shadow-2xl'>
                    <div class='text-center'>
                            ...
                            <form action='db.php' method='post' enctype='multipart/form-data'>
                                <input type='text' name='course_name' placeholder='Enter the course name' class='w-3/5 bg-none px-2 py-2 mt-4 border-none'/>
                                <input type='text' name='course_duration' placeholder='Enter the course duration' class='w-3/5 bg-none px-2 py-2 mt-4 border-none'/>
                                <input type='file' name='dp' placeholder='Enter the course duration' class='w-3/5 bg-none px-2 py-2 mt-4 border-none'/>
                                <input type="submit" class="px-6 py-3 w-full bg-green-500 text-white text-lg font-semibold leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out mt-7" name="send" value="Sign Up">
                            </form>
                    </div>
                </div>
            </div>
