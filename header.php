...
<header class="text-gray-600 body-font ml-24 sticky top-0">
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <nav class="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center gap-4">
            <a href='onlinePayment.php' class="text-sm font-semibold px-3 py-2 rounded-lg shadow-lg hover:bg-teal-700 bg-teal-300 cursor-pointer">Online Payment</a>
            <a href='studentAdmission.php' class="text-sm font-semibold px-3 py-2 rounded-lg shadow-lg hover:bg-teal-700 bg-teal-600 cursor-pointer">Apply For Admission</a>
